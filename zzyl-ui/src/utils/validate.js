...
export function parseIdCard(idCard) {
  ...
  try {
    ...
    const sexCode = parseInt(idCard.substr(16, 1))
    const sex = sexCode % 2 === 1 ? 0 : 1 // 0-男，1-女 (根据原代码中的性别选项)
...
export function validateIdCard(rule, value, callback) {
  ...
  if (!isCardID(rule, value, callback)) {
